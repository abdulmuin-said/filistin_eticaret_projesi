...
**FilistinProje** (formerly *CANVASİA* / *MeteorGaleri*) — ASP.NET Core 8.0 MVC e-commerce site, backed by PostgreSQL. Turkish-language UI and Turkish-named entities/tables throughout.
...
- `FilistinProje.Web/secrets.json` — local dev DB connection string (gitignored in spirit; do not commit real values).
