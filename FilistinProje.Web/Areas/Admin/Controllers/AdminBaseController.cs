...
namespace FilistinProje.Web.Areas.Admin.Controllers
{
    ...
    public class AdminBaseController : Controller
    {
        public override async Task OnActionExecutionAsync(ActionExecutingContext context, ActionExecutionDelegate next)
        {
            ...
            ViewBag.CanManageWholesale = AdminPermissionMatrix.CanManageWholesale(User);
            ViewBag.CanManageBankAccounts = AdminPermissionMatrix.CanManageBankAccounts(User);
            ViewBag.CanManageWholesaleGroups = AdminPermissionMatrix.CanAccess(User, "ToptanciUrunGrubu", "GET");
            ViewBag.CanManageShippingAreas = AdminPermissionMatrix.CanManageShippingAreas(User);
            ViewBag.CanManageStaff = AdminPermissionMatrix.CanManageStaff(User);
            ViewBag.CanManagePermissions = AdminPermissionMatrix.CanManageStaff(User);
