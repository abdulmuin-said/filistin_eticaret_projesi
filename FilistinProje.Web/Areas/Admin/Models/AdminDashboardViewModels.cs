namespace FilistinProje.Core.Models
{
    public class AdminDashboardViewModel
    {
        ...
        public IReadOnlyList<DashboardCitySalesItem> CitySales { get; set; } = Array.Empty<DashboardCitySalesItem>();
        public IReadOnlyList<DashboardCategorySalesItem> CategorySales { get; set; } = Array.Empty<DashboardCategorySalesItem>();
    }
    ...
    public class DashboardCitySalesItem
    {
    ...
    public class DashboardCategorySalesItem
    {
