...
namespace FilistinProje.Web.Security
{
    public static class AdminSecurityRoles
    {
        ...
        private static readonly Dictionary<string, AdminRoleOption> RoleMetadata = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            [Wholesale] = new AdminRoleOption(Wholesale, "Toptancı", "Toptan satış fiyatlarını gören müşteri.", 8),
            [Uye] = new AdminRoleOption(Uye, "Üye", "Sadece mağaza kullanıcısıdır.", 9)
        };
