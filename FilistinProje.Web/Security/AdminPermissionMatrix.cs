...
namespace FilistinProje.Web.Security
{
    public static class AdminPermissionMatrix
    {
        ...
        public static bool CanManageWholesale(ClaimsPrincipal user) => CanAccess(user, "Toptanci", HttpMethods.Get);
        public static bool CanManageBankAccounts(ClaimsPrincipal user) => CanAccess(user, "Bankalar", HttpMethods.Get);
        public static bool CanManageShippingAreas(ClaimsPrincipal user) => CanAccess(user, "Kargo", HttpMethods.Get);
        public static bool CanManageStaff(ClaimsPrincipal user) => CanAccess(user, "Personel", HttpMethods.Get);
    }
}
