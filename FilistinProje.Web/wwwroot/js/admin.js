...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // MOBILE DRAWER NAV
    // =============================================
    const mobileMenuToggle = document.getElementById('caMobileMenuToggle');
    const mobileDrawer = document.getElementById('caMobileDrawer');
    const mobileOverlay = document.getElementById('caMobileOverlay');
    const mobileDrawerClose = document.getElementById('caMobileDrawerClose');
    ...
    document.querySelectorAll('[data-bs-toggle="dropdown"]').forEach(function (el) {
        ...
        el.addEventListener('click', function (event) {
            ...
            var menu = el.parentElement ? el.parentElement.querySelector('.dropdown-menu') : null;
            if (!menu) return;
