...
\restrict MICgit90Dm7fVbwTIRsBJ02OSCNOau6A9w9EjMO32D2Bjb7eFcrimNNC61Q1UV9
...
ALTER TABLE IF EXISTS ONLY public."CarkKazanimlari" DROP CONSTRAINT IF EXISTS "FK_CarkKazanimlari_Kuponlar_KuponId";
ALTER TABLE IF EXISTS ONLY public."CarkKazanimlari" DROP CONSTRAINT IF EXISTS "FK_CarkKazanimlari_CarkOdulleri_CarkOdulId";
ALTER TABLE IF EXISTS ONLY public."CarkKazanimlari" DROP CONSTRAINT IF EXISTS "FK_CarkKazanimlari_AspNetUsers_AppUserId";
...
DROP INDEX IF EXISTS public."IX_CarkKazanimlari_KuponId";
DROP INDEX IF EXISTS public."IX_CarkKazanimlari_CarkOdulId";
DROP INDEX IF EXISTS public."IX_CarkKazanimlari_AppUserId";
...
ALTER TABLE IF EXISTS ONLY public."CarkKazanimlari" DROP CONSTRAINT IF EXISTS "CarkKazanimlari_pkey";
...
DROP TABLE IF EXISTS public."CarkKazanimlari";
...
--
-- Name: CarkKazanimlari; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public."CarkKazanimlari" (
    "Id" integer NOT NULL,
    "AppUserId" text NOT NULL,
    "CarkOdulId" integer NOT NULL,
    "KuponId" integer,
...
--
-- Name: CarkKazanimlari_Id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public."CarkKazanimlari" ALTER COLUMN "Id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public."CarkKazanimlari_Id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public."SiteAyarlari" (
    ...
    "HeroBaslikAr" text DEFAULT 'جلب الفن الفلسطيني إلى منزلك'::text NOT NULL,
    "HeroBaslikEn" text DEFAULT 'Bring Palestinian Art to Your Home'::text NOT NULL,
    "HeroBaslikTr" text DEFAULT 'Filistin Sanatını Evinize Getirin'::text NOT NULL,
    "HeroAltBaslikAr" text DEFAULT 'تصاميم فريدة تجمع بين التراث والحداثة'::text NOT NULL,
    "HeroAltBaslikEn" text DEFAULT 'Unique designs blending heritage and modernity'::text NOT NULL,
    "HeroAltBaslikTr" text DEFAULT 'Mirasa modern bir dokunuş katan özel tasarımlar'::text NOT NULL,
...
abdulmuin:23104:4fbc538b-e417-4af3-b5cf-da0c2cc94215	{"Queues": ["default"], "StartedAt": "2026-07-12T15:06:06.0862365Z", "WorkerCount": 20}	2026-07-12 15:11:36.371873+00	0
\.
...
--
-- Data for Name: CarkKazanimlari; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public."CarkKazanimlari" ("Id", "AppUserId", "CarkOdulId", "KuponId", "OlusturulmaTarihi", "SilindiMi") FROM stdin;
1	57039d3f-f6b2-498e-9a3b-0e985154adad	7	\N	2026-07-12 15:09:50.706065+00	f
\.
...
45	11	Hayfa (Haifa)	2026-07-09 18:23:19.673619+00	f	Hayfa (Haifa)	حيفا
46	11	Nasıra (Nazareth)	2026-07-09 18:23:19.704406+00	f	Nasıra (Nazareth)	الناصرة
47	11	Akka (Acre)	2026-07-09 18:23:19.704777+00	f	Akka (Acre)	عكا
48	11	Ümmü'l-Fahm	2026-07-09 18:23:19.70486+00	f	Ümmü'l-Fahm	أم الفحم
49	12	Yafa (Jaffa)	2026-07-09 18:23:19.704972+00	f	Yafa (Jaffa)	يافا
50	12	Lydda	2026-07-09 18:23:19.705038+00	f	Lydda	اللد
51	12	Ramla	2026-07-09 18:23:19.705126+00	f	Ramla	الرملة
52	12	Taybe	2026-07-09 18:23:19.705181+00	f	Taybe	الطيبة
53	13	Cenin (Jenin)	2026-07-09 18:23:19.705234+00	f	Cenin (Jenin)	جنين
54	13	Nablus	2026-07-09 18:23:19.705277+00	f	Nablus	نابلس
55	13	Ramallah & El-Bireh	2026-07-09 18:23:19.705316+00	f	Ramallah & El-Bireh	رام الله والبيرة
56	13	El-Halil (Hebron)	2026-07-09 18:23:19.705363+00	f	El-Halil (Hebron)	الخليل
57	13	Beytüllahim (Bethlehem)	2026-07-09 18:23:19.7054+00	f	Beytüllahim (Bethlehem)	بيت لحم
58	13	Salfit	2026-07-09 18:23:19.705455+00	f	Salfit	سلفيت
59	13	Tubas	2026-07-09 18:23:19.7055+00	f	Tubas	طوباس
60	13	Tulkarim	2026-07-09 18:23:19.705545+00	f	Tulkarim	طولكرم
61	13	Kalkilya (Qalqilya)	2026-07-09 18:23:19.70562+00	f	Kalkilya (Qalqilya)	قلقيلية
62	13	Eriha (Jericho)	2026-07-09 18:23:19.70567+00	f	Eriha (Jericho)	أريحا
63	14	El-Kudüs (Jerusalem)	2026-07-09 18:23:19.705728+00	f	El-Kudüs (Jerusalem)	القدس
\.
...
11	48 İç Bölge (Kuzey)	1	2026-07-09 18:23:19.538061+00	f	Filistin	Hayfa - Nasıra - Akka - Ümmü'l-Fahm (48 kuzey)	0
12	48 İç Bölge (Merkez)	2	2026-07-09 18:23:19.569744+00	f	Filistin	Yafa - Lydda - Ramla - Taybe (48 merkez)	0
13	Batı Şeria (Kuzey / Merkez)	3	2026-07-09 18:23:19.5705+00	f	Filistin	Cenin - Nablus - Ramallah - El-Halil - Beytüllahim - Salfit - Tubas - Tulkarim - Kalkilya - Eriha	0
14	Kudüs	4	2026-07-09 18:23:19.57075+00	f	Filistin	El-Kudüs (ayrı bölge)	0
\.
...
78	أثاث منزلي	أثاث منزلي عصري	أثاث عصري وأنيق لمنزلك	home-furniture	\N	\N							1	t	\N	2026-07-07 15:58:35.064707+00	f	تصفح أثاثاً منزلياً عصرياً يجمع بين الراحة والأناقة.	Explore modern home furniture selected for comfort and style.	أثاث منزلي	Home Furniture					أثاث منزلي عصري	Modern home furniture for elegant living spaces.							f	\N
79	إلكترونيات	إلكترونيات حديثة	أحدث الأجهزة الإلكترونية	electronics	\N	\N							2	t	\N	2026-07-07 15:58:35.064707+00	f	اكتشف الإلكترونيات الحديثة والأجهزة الذكية للاستخدام اليومي.	Discover modern electronics and smart everyday devices.	إلكترونيات	Electronics					إلكترونيات حديثة	Modern electronics and smart devices.							f	\N
80	أزياء	أزياء عصرية	أزياء عصرية للرجال والنساء	fashion	\N	\N							3	t	\N	2026-07-07 15:58:35.064707+00	f	تصفح قطع الأزياء العصرية والإكسسوارات.	Browse contemporary fashion pieces and accessories.	أزياء	Fashion					أزياء عصرية	Contemporary fashion and accessories.							f	\N
\.
...
14	59	50	55	2	1299.00	فستان سهرة أنيق				\N	2026-07-08 15:24:48.902683+00	f	0	f
13	59	48	53	8	4999.00	طقم كنبات مودرن			Varsayilan varyasyon	\N	2026-07-07 19:33:57.183748+00	f	0	f
15	59	49	54	3	799.00	ساعة ذكية				\N	2026-07-08 15:46:46.882792+00	f	0	f
\.
...
1	E2E Tester	sink@example.invalid	2	E2E site review	Site review approval flow test	t	2026-07-12 15:08:54.044812+00	f
\.
...
50	فستان سهرة أنيق	فستان سهرة	elegant-evening-dress							فستان سهرة	فستان سهرة بتصميم عصري						InStock	1299.00	\N	0	0	1	1	1	t	f	t	f	f	1	0	0	0	1	0				80	2026-07-07 15:58:35.069193+00	f	\N	فستان سهرة بتصميم عصري	Elegant evening dress with a modern refined design.	فستان سهرة أنيق	Elegant Evening Dress	فستان سهرة	Evening dress					0	f	f	f	\N	\N	t
51	حقيبة جلدية	حقيبة جلدية	leather-handbag							حقيبة جلدية	حقيبة جلدية فاخرة للنساء						InStock	899.00	\N	0	0	1	1	1	t	f	t	f	f	1	1	0	0	1	0				80	2026-07-07 15:58:35.069193+00	f	\N	حقيبة جلدية فاخرة للنساء	Premium leather handbag for women with a refined finish.	حقيبة جلدية	Leather Handbag	حقيبة جلدية	Leather handbag					0	f	f	f	\N	\N	t
49	ساعة ذكية	ساعة ذكية	smart-watch							ساعة ذكية	ساعة ذكية بمميزات متعددة						InStock	799.00	\N	0	0	1	1	1	t	f	t	f	f	1	14	0	0	1	0				79	2026-07-07 15:58:35.069193+00	f	\N	ساعة ذكية بمميزات متعددة	Smart watch with multiple daily health and lifestyle features.	ساعة ذكية	Smart Watch	ساعة ذكية	Smart watch					0	f	f	f	\N	\N	t
48	طقم كنبات مودرن	كنبات مودرن	modern-sofa-set							كنبات مودرن	طقم كنبات فاخر من 5 قطع						InStock	4999.00	\N	0	0	1	1	1	t	f	t	f	f	1	13	0	0	1	0				78	2026-07-07 15:58:35.069193+00	f	\N	طقم كنبات فاخر من 5 قطع	Luxury five-piece modern sofa set for elegant living rooms.	طقم كنبات مودرن	Modern Sofa Set	كنبات مودرن	Modern sofa set					0	f	f	f	\N	\N	t
\.
...
1	48	57039d3f-f6b2-498e-9a3b-0e985154adad	7ANRPS48 Admin	E2E review 2026-07-12	2	t	2026-07-12 15:07:14.014107+00	f
\.
...
1472	::1	/Hesap/GirisYap	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36		admin@7anrps48.com	GET	-	-	Chrome	PC (Windows)	Windows	2026-07-12 14:56:51.873542+00	f
1473	::1	/	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36	http://localhost:5002/Hesap/GirisYap	admin@7anrps48.com	GET	-	-	Chrome	PC (Windows)	Windows	2026-07-12 14:57:23.91606+00	f
1474	::1	/Urun/Detay/modern-sofa-set-48	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36		admin@7anrps48.com	GET	-	-	Chrome	PC (Windows)	Windows	2026-07-12 15:06:22.594434+00	f
1475	::1	/Urun/Detay/modern-sofa-set-48	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36		admin@7anrps48.com	GET	-	-	Chrome	PC (Windows)	Windows	2026-07-12 15:06:26.874788+00	f
1476	::1	/Urun/Detay/48	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36	http://localhost:5002/Urun/Detay/modern-sofa-set-48	admin@7anrps48.com	GET	-	-	Chrome	PC (Windows)	Windows	2026-07-12 15:07:14.105909+00	f
1477	::1	/Urun/Detay/48	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36		admin@7anrps48.com	GET	-	-	Chrome	PC (Windows)	Windows	2026-07-12 15:08:03.154545+00	f
1478	::1	/Home/SiteDegerlendir	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36		admin@7anrps48.com	GET	-	-	Chrome	PC (Windows)	Windows	2026-07-12 15:08:15.960012+00	f
1479	::1	/Home/SiteDegerlendir	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36	http://localhost:5002/Home/SiteDegerlendir	admin@7anrps48.com	GET	-	-	Chrome	PC (Windows)	Windows	2026-07-12 15:08:54.094866+00	f
1480	::1	/	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36		admin@7anrps48.com	GET	-	-	Chrome	PC (Windows)	Windows	2026-07-12 15:09:39.821215+00	f
\.
...
20260712150132_AddCarkKazanimi	8.0.4
\.
...
--
-- Name: CarkKazanimlari_Id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public."CarkKazanimlari_Id_seq"', 1, true);
...
SELECT pg_catalog.setval('public."SiteDegerlendirmeleri_Id_seq"', 1, true);
...
SELECT pg_catalog.setval('public."Yorumlar_Id_seq"', 1, true);
...
SELECT pg_catalog.setval('public."ZiyaretciLoglari_Id_seq"', 1480, true);
...
--
-- Name: CarkKazanimlari CarkKazanimlari_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."CarkKazanimlari"
    ADD CONSTRAINT "CarkKazanimlari_pkey" PRIMARY KEY ("Id");
...
--
-- Name: IX_CarkKazanimlari_AppUserId; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "IX_CarkKazanimlari_AppUserId" ON public."CarkKazanimlari" USING btree ("AppUserId");


--
-- Name: IX_CarkKazanimlari_CarkOdulId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_CarkKazanimlari_CarkOdulId" ON public."CarkKazanimlari" USING btree ("CarkOdulId");


--
-- Name: IX_CarkKazanimlari_KuponId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_CarkKazanimlari_KuponId" ON public."CarkKazanimlari" USING btree ("KuponId");
...
--
-- Name: CarkKazanimlari FK_CarkKazanimlari_AspNetUsers_AppUserId; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."CarkKazanimlari"
    ADD CONSTRAINT "FK_CarkKazanimlari_AspNetUsers_AppUserId" FOREIGN KEY ("AppUserId") REFERENCES public."AspNetUsers"("Id") ON DELETE CASCADE;


--
-- Name: CarkKazanimlari FK_CarkKazanimlari_CarkOdulleri_CarkOdulId; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."CarkKazanimlari"
    ADD CONSTRAINT "FK_CarkKazanimlari_CarkOdulleri_CarkOdulId" FOREIGN KEY ("CarkOdulId") REFERENCES public."CarkOdulleri"("Id") ON DELETE RESTRICT;


--
-- Name: CarkKazanimlari FK_CarkKazanimlari_Kuponlar_KuponId; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."CarkKazanimlari"
    ADD CONSTRAINT "FK_CarkKazanimlari_Kuponlar_KuponId" FOREIGN KEY ("KuponId") REFERENCES public."Kuponlar"("Id") ON DELETE SET NULL;
...
\unrestrict MICgit90Dm7fVbwTIRsBJ02OSCNOau6A9w9EjMO32D2Bjb7eFcrimNNC61Q1UV9
